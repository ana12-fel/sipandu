"""
Django settings for sipandu_project project.
...
SECRET_KEY = 'django-insecure-kpcu@7g4_)o(h88@y)kqmm0%h8bi0r*z4=(u&f(#0ikdy*3_0$'
...
WSGI_APPLICATION = 'sipandu_project.wsgi.application'
...
AUTH_USER_MODEL = 'sipandu_app.Master_user'
...
# Lokasi di mana file media akan disimpan
