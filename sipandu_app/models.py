...
class Master_wilayah(models.Model):
    ...
    wilayah_provinsi = models.TextField(default="Papua Tengah")
    wilayah_kabupaten = models.TextField(default="Nabire")
    wilayah_distrik = models.TextField(default="Lambar")
