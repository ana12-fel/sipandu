...
from .views import base_views,admin_views,jenjang_view,user_view
...
urlpatterns = [
    ...
    path('admin/jenjang/<uuid:jenjang_id>/delete/', jenjang_view.delete_jenjang, name='delete_jenjang'),
