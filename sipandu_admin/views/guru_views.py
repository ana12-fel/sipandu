...
def EditGuru(request, id_data_guru):
    if request.method == 'POST':
        dt_guru = Data_guru.objects.get(id_data_guru=id_data_guru)
        ...
        dt_guru.guru_sekolah=Master_sekolah.objects.get(sekolah_id=guru_sekolah)
        ...
        return render(request, 'admin/data/edit_guru.html', {'data_sekolah' : data_sekolah, 'data_guru' : data_guru})
